...
# 397 "../src/http.h"
extern _u8 orion_httpGet(orion_httpRequest* req, void (*callback)(char*,_u32), _u32 count);
...
extern void orion_cleanupCookie(orion_cookie* cookie);
extern void orion_setCookie(orion_cookie *cookie, const char* name, const char* value, const char* comment, const char* domain, const char* max_age, const char* path, const char* secure, const char* version, const char* expires);
...
int main()
{
    ...
    parse_cookie(&c, "PREF=ID=e52d156f7713a539:FF=0:TM=1294551749:LM=1294551749:S=oJ5bYafPIDsLW2zc; expires=Tue, 08-Jan-2013 05:42:29 GMT; path=/; domain=.google.com");
...
{
    char delim, *buffer = strdup(cookie);
    ssize_t i;
    ...
    if (delim == '=')
    {
        ...
        if (i > 0)
        {
            ...
            fprintf(stdout, "VALUE=%s", c->value);
